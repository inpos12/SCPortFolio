  ...
  return (
    <>
      <ContentRow $maxHeight="auto" $maxWidth="auto" className="fade-in">
        ...
        />
        <h1 className="mt-10 mb-20">Seung Chan's Portfolio</h1>
        <Hr />
        <h2 className="mb-20">AboutMe</h2>
        <GrayText style={{ lineHeight: "30px" }} className="mb-20">
          웹퍼블리셔로서 HTML, CSS, JavaScript, jQuery, React를 활용하여 웹
          사이트를 효율적이고 사용자 친화적으로 구현해왔습니다. <br /> 독학을
          통해 웹 페이지 구조와 스타일링, 동적인 사용자 인터페이스, 컴포넌트
          기반의 애플리케이션 설계에 대한 기술을 익혔습니다.
        ...
        <CodeBox>
         ...
         date: "1997.01.05",
         phone: "010-8686-9869"
         email: "tmdcks86869869@gmail.com"
        };`}
          </PreGrayText>
        </CodeBox>
        <Hr />
